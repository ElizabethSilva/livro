...
public class Livro { //criando classe Livro.
    ...
    public int getId() { //getId tem como funcionalidade pegar o valor de id.
        return id; //retorna o id.
    }
    public void setId(int id) { //setId tem como funcionalidade definir o valor de id.
        this.id = id; //configura o valor de id, conforme o passado no parâmetro.
    }
    public String getTitulo() { //getTitulo tem como funcionalidade pegar o valor de titulo.
        return titulo; ////retorna o titulo.
    }
    public void setTitulo(String titulo) { //setTitulo tem como funcionalidade definir o valor de titulo.
